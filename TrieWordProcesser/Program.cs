...
namespace TrieWordProcesser
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine(string.Format("First longest word: {0}", topTwenty[0].Name));
            Console.WriteLine(string.Format("Second longest word: {0}", topTwenty[1].Name));
            Console.WriteLine(string.Format("Total number of words constructed of other words: {0}", completewords.Count));
            Console.WriteLine();
